    ...
    <main class="narrow">
        ...
        <section id="problems">
            ...
            <ul class="spaced-list">
	           ...
	           <li><em>Pathologising</em>. This is so extensive it's barely worth mentioning. Descriptions of autism almost universally describe it as a disorder, illness, or disease, and the traits as symptoms and deficits. This bias is both inaccurate and harmful.</li>
                    ...
                    <ol>
	                    ...
	                    <li>D. Different use of facial expressions.
                            <ul>
                                ...
                                <li>May use more expressive or extreme facial expressions than others.</li>
                            </ul>
                        </li>
                    </ol>
                </li>
                   ...
                   <ol>
                        <li>Different use of literal and metaphorical communication.
                            <ul>
                                ...
                                <li>May use words to have different meanings than others.</li>
                            </ul>
                        </li>
                        <li>Different use of speech.
                            <ul>
                                ...
                                <li>May have a strong preference for text-based communication or difficulty using speech.</li>
                                <li>May have a strong preference for speech or difficulty using text-based communication.</li>
                            </ul>
                        </li>
                    </ol>
                </li>
                    ...
                    <ol>
                        <li>Different desire for relationships.
                            <ul>
                                ...
                                <li>May be very reliant on social norms and rules to guide relationships.</li>
                            </ul>
                        </li>
                        <li>Different preferences for groups.
                            <ul>
                                ...
                                <li>May find presenting to crowds easier than reciprocal interactions.</li>
                            </ul>
                        </li>
                        ...
                        <li>Different social instincts to other people.
                            <ul>
                                ...
                                <li>May feel like part of a different culture.</li>
                            </ul>
                        </li>
                    </ol>
                </li>
                    ...
                    <ol>
                        <li>Intense focus and interests.
                            <ul>
                                ...
                                <li>May have in-depth and expert knowledge about interest topics.</li>
                            </ul>
                        </li>
                        <li>Preference for routine and sameness.
                            <ul>
                                ...
                                <li>May be more anxious than others when in new or unfamiliar situations.</li>
                            </ul>
                        </li>
                    </ol>
                </li>
                    ...
                    <ol>
                        <li>Differences in executive function.
                            <ul>
                                ...
                                <li>May have poor impulse control.</li>
                                <li>May have poor sense of time.</li>
                            </ul>
                        </li>
                        <li>Differences in experiencing and processing emotions.
                            <ul>
                                ...
                                <li>May involuntarily experience others' emotions.</li>
                            </ul>
                        </li>
                    ...
                    <ol>
                        <li>Different approach to details.
                            <ul>
                                ...
                                <li>May have difficulty generalising from specific examples.</li>
                            </ul>
                        </li>
                        <li>Different approach to patterns and systems.
                            <ul>
                                ...
                                <li>May enjoy organising and arranging information or objects.</li>
                            </ul>
                        </li>
